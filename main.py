...
parser.add_argument('--state_only', default=True,help='state_only',action='store_true')
...
parser.add_argument('--fixed_len', default=False,help='fixed len traj',action='store_true')
...
parser.add_argument('--encoder_base', type=str,default='mlp',help='Polcy struture',choices=['mlp','transformer'])
